...
总体估计（High level estimates，HLE）：假设每月个5亿个新的URL和100:1的读写比率，以下是我们系统的总体估计（High level estimates，HLE）摘要：
...
<figure><img src="../.gitbook/assets/image (15).png" alt=""><figcaption><p>URL缩短总体系统设计</p></figcaption></figure>
