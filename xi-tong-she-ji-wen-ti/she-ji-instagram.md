...
3. 如果用户一段时间没有拉取照片导致一致性收到影响（为了可用性），这是可以接受的。
...
**或者**，我们可以实现类似于我们在[设计像 TinyURL 这样的 URL 缩短服务](https://www.educative.io/collection/page/5668639101419520/5649050225344512/5668600916475904)中讨论过的“密钥”生成方案
...
我们可以将所有拥有大量关注的用户移动到基于拉动的模型中，并且只将数据推送给那些拥有数百（或数千）关注的用户。
